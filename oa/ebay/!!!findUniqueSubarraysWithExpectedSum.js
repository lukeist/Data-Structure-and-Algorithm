...
//   const first = arr[0];
//   const excludeFirst = findSubarraysWithSum(arr.slice(1), sum);
//   const includeFirst = findSubarraysWithSum(arr.slice(1), sum - first);
...
//   const first = arr[0];
//   const excludeFirst = findSubarraysWithSum(arr.slice(1), sum);
//   const includeFirst = findSubarraysWithSum(arr.slice(1), sum - first).map(
//     (a) => [...a, first]
//   );
